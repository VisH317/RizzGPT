    ...
    return (
        <div className="flex min-h-screen flex-row bg-gradient-to-b from-black to-[#15162c]">
            ...
            <div className="px-20 py-10 w-1/2 flex flex-col gap-5">
                <div className="grow w-full overflow-auto gap-5 flex flex-col">
                    {mapMessages()}
                </div>
                <div className='flex-none w-full flex flex-row'>
                    ...
                    <button className='w-[10%] bg-gradient-to-r from-blue-500 to-fuchsia-500 rounded-tr-lg rounded-br-lg flex justify-center items-center group' onClick={() => void submitMessage()}>
